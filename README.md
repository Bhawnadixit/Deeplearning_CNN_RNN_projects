...
For this first assignment, the task was to classify the MNIST dataset, which consists of labelled handwritten digits. The objective of the assignment was to create and train a model that can generalise well for
unseen samples.

DL_GA_2: Classifying the CIFAR 100 image dataset with 20 classes.
